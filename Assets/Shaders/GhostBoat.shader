	...
	SubShader
	{
		...
		Pass
		{
            ...
            v2f vert (appdata v)
            {
                ...
                o.pos = v.vertex;
                o.wpos = mul(unity_ObjectToWorld, v.vertex -  - float4(_PositionTweak.xyz, 0));
                return o;
            }
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 objectPos = float3(m._14, m._24, m._34);
                ...
                float density = _Density * (fragPosWS.y);// * (1 - (fragPosWS.y - objectPos.y + objScale/2.0)/objScale);
