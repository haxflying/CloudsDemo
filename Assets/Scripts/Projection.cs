...
public class Projection
{
    ...
    public CullMode IsFlipped { get; private set; }
    ...
    void AimProjector(Camera cam)
    {
        ...
        if (pos.y < OceanLevel - MaxHeight)
        {
            IsFlipped = CullMode.Front;
            pos.y = Math.Min(pos.y, OceanLevel - range);
        }
        else if(pos.y > OceanLevel - MaxHeight && pos.y < OceanLevel + MaxHeight)
        {
            IsFlipped = CullMode.Off;
        }
        else
        {
            IsFlipped = CullMode.Back;
